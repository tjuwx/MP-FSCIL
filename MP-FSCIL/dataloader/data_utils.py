...
def get_pre_dataloader(args):
    ...
    trainloader = torch.utils.data.DataLoader(dataset=trainset, batch_size=args.pre_batch_size, shuffle=True,
...
def get_meta_dataloader(args):
    ...
    sampler = CategoriesSampler(trainset.targets, args.meta_episode, args.meta_way,
                                args.meta_shot + args.meta_query)
